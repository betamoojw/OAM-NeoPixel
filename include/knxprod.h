...
#define NEO_NEOEffectReverseDirection           10      // 1 Bit, Bit 5
#define     NEO_NEOEffectReverseDirectionMask 0x20
#define     NEO_NEOEffectReverseDirectionShift 5
#define NEO_NEOSegmentPowerOnBehaviour          10      // 3 Bits, Bit 4-2
#define     NEO_NEOSegmentPowerOnBehaviourMask 0x1C
#define     NEO_NEOSegmentPowerOnBehaviourShift 2
...
// Umgekehrte Richtung des Effekts
#define ParamNEO_NEOEffectReverseDirection           ((bool)(knx.paramByte(NEO_ParamCalcIndex(NEO_NEOEffectReverseDirection)) & NEO_NEOEffectReverseDirectionMask))
// Einschaltverhalten
#define ParamNEO_NEOSegmentPowerOnBehaviour          ((knx.paramByte(NEO_ParamCalcIndex(NEO_NEOSegmentPowerOnBehaviour)) & NEO_NEOSegmentPowerOnBehaviourMask) >> NEO_NEOSegmentPowerOnBehaviourShift)
// Effekt Typ
...
#define NEO_KoFxSpeed 17
#define NEO_KoFxIntensity 18
#define NEO_KoFxOption1 19
#define NEO_KoFxOption2 20
#define NEO_KoFxOption3 21
#define NEO_KoFxFeature1 22
#define NEO_KoFxFeature2 23
#define NEO_KoFxFeature3 24
#define NEO_KoPreset 25
#define NEO_KoPresetState 26
#define NEO_KoRGB 27
#define NEO_KoRGBState 28
#define NEO_KoHSV 29
#define NEO_KoHSVState 30
#define NEO_KoRGBW 31
#define NEO_KoRGBWState 32
#define NEO_KoBriRel 33
#define NEO_KoRRel 34
#define NEO_KoGRel 35
#define NEO_KoBRel 36
#define NEO_KoWRel 37
#define NEO_KoWWRel 38
#define NEO_KoCWRel 39
#define NEO_KoHRel 40
#define NEO_KoSRel 41
#define NEO_KoVRel 42
#define NEO_KoFxRel 43
#define NEO_KoRGBRel 44
#define NEO_KoHSVRel 45
#define NEO_KoRGBWRel 46
...
#define KoNEO_FxSpeed                             (knx.getGroupObject(NEO_KoCalcNumber(NEO_KoFxSpeed)))
// Effekt Intensität
#define KoNEO_FxIntensity                         (knx.getGroupObject(NEO_KoCalcNumber(NEO_KoFxIntensity)))
// Effekt Option 1
#define KoNEO_FxOption1                           (knx.getGroupObject(NEO_KoCalcNumber(NEO_KoFxOption1)))
// Effekt Option 2
#define KoNEO_FxOption2                           (knx.getGroupObject(NEO_KoCalcNumber(NEO_KoFxOption2)))
// Effekt Option 3
#define KoNEO_FxOption3                           (knx.getGroupObject(NEO_KoCalcNumber(NEO_KoFxOption3)))
// Effekt Feature 1
#define KoNEO_FxFeature1                          (knx.getGroupObject(NEO_KoCalcNumber(NEO_KoFxFeature1)))
// Effekt Feature 2
#define KoNEO_FxFeature2                          (knx.getGroupObject(NEO_KoCalcNumber(NEO_KoFxFeature2)))
// Effekt Feature 3
#define KoNEO_FxFeature3                          (knx.getGroupObject(NEO_KoCalcNumber(NEO_KoFxFeature3)))
// Voreinstellung
